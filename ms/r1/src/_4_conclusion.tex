...
Future work should explore adaptive methods for enhancing model generalization across varied viewpoints and environmental conditions. In particular, incorporating advanced data augmentation techniques that simulate diverse camera angles in 3D space may help address viewpoint-induced performance degradation.
